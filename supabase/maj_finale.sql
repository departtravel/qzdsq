-- ============================================================
-- DTS OPERATION ERP — MISE À JOUR (compta auto + charges fixes)
-- Colle TOUT ce fichier dans Supabase > SQL Editor > Run without RLS.
-- Contient : liens prestataires, moteur de compta automatique,
-- et le module charges fixes. Ré-exécutable. Remplace maj_compta_auto.sql.
-- Prérequis : install_complet.sql + maj_operations.sql déjà passés.
-- ============================================================
