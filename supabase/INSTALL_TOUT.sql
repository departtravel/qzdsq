...
-- UN SEUL fichier à coller dans Supabase > SQL Editor > Run without RLS.
-- Contient TOUT, y compris la refonte Planning (multi-guides/transports).
-- 100% ré-exécutable : ne casse rien, crée ce qui manque.
-- ============================================================
