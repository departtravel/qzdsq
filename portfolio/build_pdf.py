...
DOCS = [
    ...
    # ---- Fam-trip 2026: one tailored catalogue per tour operator ----
    ("famtrip/rosetta-reizen.md",
     "famtrip/Depart-Travel-Tunisia-Rosetta-Reizen.pdf",
     "Tunisia for Rosetta Reizen · Depart Travel Services",
     "images/ksar-hadada.jpg", "TUNISIA",
     "Offbeat, culinary & community travel — prepared for Rosetta Reizen"),
    ("famtrip/earth-trip.md",
     "famtrip/Depart-Travel-Tunisia-Earth-Trip.pdf",
     "Tunisia for Earth Trip · Depart Travel Services",
     "images/sidi-bou-said.jpg", "TUNISIA",
     "Responsible luxury, beyond the beach — prepared for Earth Trip"),
    ("famtrip/via-verde.md",
     "famtrip/Depart-Travel-Tunisia-Via-Verde.pdf",
     "Tunisia for Via Verde · Depart Travel Services",
     "images/mountain-oasis.jpg", "TUNISIA",
     "Sustainable hiking, nature & local crafts — prepared for Via Verde"),
    ("famtrip/trotting-soles.md",
     "famtrip/Depart-Travel-Tunisia-Trotting-Soles.pdf",
     "Tunisia for Trotting Soles · Depart Travel Services",
     "images/berber-village-2.jpg", "TUNISIA",
     "Offbeat, immersive & tailor-made — prepared for Trotting Soles"),
    ("famtrip/dunia-travel.md",
     "famtrip/Depart-Travel-Tunisie-Dunia-Travel.pdf",
     "Tunisie pour Dunia Travel · Depart Travel Services",
     "images/desert-camp-setup.jpg", "TUNISIE",
     "Voyages sur mesure, durables & hors des sentiers battus — pour Dunia Travel"),
    ("famtrip/journey-travel.md",
     "famtrip/Depart-Travel-Tunisia-Journey-Travel.pdf",
     "Tunisia for Journey Travel · Depart Travel Services",
     "images/tamerzapalace.jpg", "TUNISIA",
     "Boutique stays, desert glamping & farm-to-table — prepared for Journey Travel"),
    ("famtrip/village-adventures.md",
     "famtrip/Depart-Travel-Tunisia-Village-Adventures.pdf",
     "Tunisia for Village Adventures · Depart Travel Services",
     "images/berber-village-1.jpg", "TUNISIA",
     "Community-based & modular journeys — prepared for Village Adventures"),
    ("famtrip/indy-guide.md",
     "famtrip/Depart-Travel-Tunisia-Indy-Guide.pdf",
     "Tunisia for Indy Guide · Depart Travel Services",
     "images/dunesinsolites.webp", "TUNISIA",
     "Platform-ready day tours & itineraries — prepared for Indy Guide"),
    ("famtrip/expedition-xplore.md",
     "famtrip/Depart-Travel-Tunisia-ExpeditionXplore.pdf",
     "Tunisia for ExpeditionXplore · Depart Travel Services",
     "images/gorge-canyon.jpg", "TUNISIA",
     "Desert & Berber-highland expedition trekking — prepared for ExpeditionXplore"),
]
